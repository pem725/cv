...
<!-- Manuscripts Under Review / In Preparation: intentionally NOT rendered (held 2026-07-18).
     The submitted: and in_preparation: lists in publications.yaml come from the archival CV
     and are historical/stale (some ~20 years old, never appeared). Prune/update those entries
     in publications.yaml, then restore render sections here that loop over
     data['publications']['submitted'] and data['publications']['in_preparation']. -->
