...
IS_HTML = os.environ.get('QUARTO_FIG_FORMAT', 'png') != 'svg'
# Alternative check: typst uses svg figures
if 'QUARTO_PROJECT_OUTPUT_DIR' in os.environ:
    IS_HTML = True  # Default to HTML in project context
# Most reliable: check if we're in typst context
